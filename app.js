let registro = document.getElementById("iniciarsesion");
registro.addEventListener("click", () => {



let ingreso = prompt("Ingrese su nombre para iniciar sesion");
let edad = Number(prompt("Ingrese su edad"));
localStorage.setItem("Nombre", ingreso || "usuario no existe");
localStorage.setItem("Edad",  JSON.stringify( edad )  || "usuario no existe");


edad < 18 ? Swal.fire({
    icon: 'error',
    title: 'Importante',
    text: 'Al ser menor de 18 años usted no podra realizar pagos dentro de la pagina!',
